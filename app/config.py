...
OCR_AUTO_DOWNLOAD: bool
OCR_SHADOW_ENABLED: bool
OCR_SHADOW_PYTHON: str
OCR_SHADOW_DET_DIR: str
OCR_SHADOW_REC_DIR: str
...
def _assign_from_env() -> None:
    ...
    global OCR_FALLBACK_ENABLED, OCR_FALLBACK_BACKEND, OCR_FALLBACK_CONFIDENCE, OCR_FALLBACK_MIN_CHARS, OCR_GLM_PREFILTER_BACKEND, OCR_AUTO_DOWNLOAD
    global OCR_SHADOW_ENABLED, OCR_SHADOW_PYTHON, OCR_SHADOW_DET_DIR, OCR_SHADOW_REC_DIR
    ...
    OCR_AUTO_DOWNLOAD = _bool("OCR_AUTO_DOWNLOAD", False)
    OCR_SHADOW_ENABLED = _bool("OCR_SHADOW_ENABLED", False)
    OCR_SHADOW_PYTHON = _optional_str("OCR_SHADOW_PYTHON")
    OCR_SHADOW_DET_DIR = _optional_str("OCR_SHADOW_DET_DIR")
    OCR_SHADOW_REC_DIR = _optional_str("OCR_SHADOW_REC_DIR")
